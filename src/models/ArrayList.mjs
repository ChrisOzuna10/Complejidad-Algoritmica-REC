export class ArrayList {
    ...
    searchValue(value) {
        ...
        for (let i = 0; i < this.array.length; i++) {
            iteraciones++;
            if (value === this.array[i].name) {
                console.log("encontrado");
                return { node: this.array[i], iteraciones }; // Devuelve el nodo y el número de iteraciones
            }
        }
        console.log("No se encontró");
        return { node: null, iteraciones }; // Devuelve null si no se encontró el nodo
    }
